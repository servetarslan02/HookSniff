...
| 3 | **Go** | Go | 1.1.0 | GitHub tag | ✅ | 5/8 ⏳ | — |
| 4 | **Rust** | Rust | 1.1.0 | crates.io | ✅ | 8/8 ✅ | — |
| 5 | **Ruby** | Ruby | **1.2.0** | RubyGems | ✅ | 8/8 ✅ | 30+ resource |
| 6 | **Java** | Java | 1.1.2 | Maven Central | ✅ | 8/8 ✅ | — |
| 7 | **Kotlin** | Kotlin | 1.1.0 | Maven Central | ⏳ | bozuk | build fix gerekli |
| 8 | **PHP** | PHP | 1.1.0 | Packagist | ✅ | 2/8 ⏳ | — |
| 9 | **C#** | C# | **1.2.0** | NuGet | ✅ | 8/8 ✅ | 30+ resource |
| 10 | **Elixir** | Elixir | 1.1.1 | Hex.pm | ⏳ | 0/8 ⏳ | — |
| 11 | **Swift** | Swift | 1.1.0 | GitHub tag | ✅ | 3/8 ⏳ | — |

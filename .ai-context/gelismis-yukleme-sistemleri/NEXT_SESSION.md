...
cat .ai-context/gelismis-yukleme-sistemleri/GECIS_STRATEJISI.md  ← ⚠️ İLK BUNU OKU — nasıl geçiş yapılır, ne silinir
...
3. **Temiz geçiş** — Yeni kod çalışınca eski kodu SİL (GECIS_STRATEJISI.md'ye bak)
...
7. **Duplikasyon yok** — Aynı işi yapan iki kod birlikte durmaz

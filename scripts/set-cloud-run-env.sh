...
# Export them before running this script, or pass them inline.
...
gcloud run services update $SERVICE \
  --region=$REGION \
  --project=$PROJECT_ID \
  --set-env-vars="GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID},GOOGLE_CLIENT_SECRET=${GOOGLE_CLIENT_SECRET},GITHUB_CLIENT_ID=${GITHUB_CLIENT_ID},GITHUB_CLIENT_SECRET=${GITHUB_CLIENT_SECRET},OAUTH_REDIRECT_BASE=https://hooksniff-api-499907444852.europe-west1.run.app,APP_URL=https://hooksniff.vercel.app,CORS_ORIGINS=https://hooksniff.vercel.app,RATE_LIMIT_STORE=redis"

echo "✅ Done! OAuth providers should now show google=true, github=true"
echo "🔗 Test: curl https://hooksniff-api-499907444852.europe-west1.run.app/v1/oauth/providers"

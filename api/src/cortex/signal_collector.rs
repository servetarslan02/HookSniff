...
//!
//! PERCENTILE accuracy: Uses PostgreSQL PERCENTILE_CONT for correct p95/p99.
//! The previous AVG*1.5 approximation was WRONG for long-tailed latency distributions.
//! The query scope is limited to 1 hour of data (bounded), so the sort is manageable.

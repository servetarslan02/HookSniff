...
namespace HookSniff.Sdk.Model
{
    ...
    public partial class SearchResult : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SearchResult(List<Delivery> deliveries, int total)
        {
    ...
    public class SearchResultJsonConverter : JsonConverter<SearchResult>
    {
        ...
        public override SearchResult Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!deliveries.IsSet)
                throw new ArgumentException("Property is required for class SearchResult.", nameof(deliveries));

            if (!total.IsSet)
                throw new ArgumentException("Property is required for class SearchResult.", nameof(total));
            ...
            return new SearchResult(deliveries.Value!, total.Value!.Value!);
        }
        ...
        {
            if (searchResult.Deliveries == null)
            ...
            writer.WriteNumber("total", searchResult.Total);
        }
    }
}

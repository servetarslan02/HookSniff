...
namespace HookSniff.Sdk.Model
{
    ...
    public partial class Team : IValidatableObject
    {
        ...
        [JsonConstructor]
        public Team(Guid id, string name, DateTime createdAt)
        {
            Id = id;
            Name = name;
            CreatedAt = createdAt;
    ...
    public class TeamJsonConverter : JsonConverter<Team>
    {
        ...
        public override Team Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!name.IsSet)
                throw new ArgumentException("Property is required for class Team.", nameof(name));
            ...
            return new Team(id.Value!.Value!, name.Value!, createdAt.Value!.Value!);
        }

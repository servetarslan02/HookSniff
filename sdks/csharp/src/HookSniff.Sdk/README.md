...
additionalProperties:
  packageGuid: '{29A9E7BF-42BA-483F-BC53-05E586B9262A}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IApiKeysGetApiResponse apiResponse = await api.ApiKeysGetAsync("todo");
            List<ApiKeyInfo>? model = apiResponse.Ok();
        }
...
## Api Information
- appName: HookSniff API
- appVersion: 1.0.0
- appDescription: Webhook delivery, monitoring, and management API. All endpoints under &#x60;/v1&#x60; require authentication via &#x60;Authorization: Bearer &lt;api_key&gt;&#x60; header unless marked as **Public**. 

...
namespace hooksniff.Model
{
    ...
    public partial class AuthResponse : IValidatableObject
    {
        ...
        [JsonConstructor]
        public AuthResponse(Option<string?> token = default, Option<CustomerResponse?> customer = default, Option<string?> refreshToken = default)
        {
            TokenOption = token;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<CustomerResponse?> CustomerOption { get; private set; }

        /// <summary>
        /// Gets or Sets Customer
        /// </summary>
        [JsonPropertyName("customer")]
        public CustomerResponse? Customer { get { return this.CustomerOption.Value; } set { this.CustomerOption = new(value); } }
    ...
    public class AuthResponseJsonConverter : JsonConverter<AuthResponse>
    {
        ...
        public override AuthResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new AuthResponse(token, customer, refreshToken);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, AuthResponse authResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (authResponse.CustomerOption.IsSet && authResponse.Customer == null)
            ...
            if (authResponse.CustomerOption.IsSet)
            {

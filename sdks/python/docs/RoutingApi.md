...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RoutingApi->routing_id_health_get: %s\n" % e)
```
...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RoutingApi->routing_id_routing_get: %s\n" % e)
```
...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling RoutingApi->routing_id_routing_put: %s\n" % e)
```

...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    api_instance = hooksniff.SSOApi(api_client)

    try:
        # Delete SSO configuration
        api_instance.sso_config_delete()
    except Exception as e:
        print("Exception when calling SSOApi->sso_config_delete: %s\n" % e)
```
...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SSOApi->sso_config_get: %s\n" % e)
```
...
# **sso_config_post**
> sso_config_post(sso_config_post_request=sso_config_post_request)
...
with hooksniff.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = hooksniff.SSOApi(api_client)
    sso_config_post_request = hooksniff.SsoConfigPostRequest() # SsoConfigPostRequest |  (optional)

    try:
        # Create/update SSO configuration
        api_instance.sso_config_post(sso_config_post_request=sso_config_post_request)
    except Exception as e:
        print("Exception when calling SSOApi->sso_config_post: %s\n" % e)
```
...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling SSOApi->sso_test_post: %s\n" % e)
```

...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    api_instance = hooksniff.OAuthApi(api_client)

    try:
        # Google OAuth callback
        api_instance.oauth_google_callback_get()
    except Exception as e:
        print("Exception when calling OAuthApi->oauth_google_callback_get: %s\n" % e)
```
...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling OAuthApi->oauth_google_get: %s\n" % e)
```
...
with hooksniff.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling OAuthApi->oauth_providers_get: %s\n" % e)
```

...
class NotificationPreferences(BaseModel):
    ...
    """ # noqa: E501
    email_on_failure: Optional[StrictBool] = True
    email_on_dead_letter: Optional[StrictBool] = True
    email_on_success: Optional[StrictBool] = False
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "email_on_failure": obj.get("email_on_failure") if obj.get("email_on_failure") is not None else True,
            "email_on_dead_letter": obj.get("email_on_dead_letter") if obj.get("email_on_dead_letter") is not None else True,
            "email_on_success": obj.get("email_on_success") if obj.get("email_on_success") is not None else False,

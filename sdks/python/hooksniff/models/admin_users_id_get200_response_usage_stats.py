...
class AdminUsersIdGet200ResponseUsageStats(BaseModel):
    """
    ...
    endpoints_count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["total_deliveries", "success_rate", "endpoints_count"]

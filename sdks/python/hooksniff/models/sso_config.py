...
class SSOConfig(BaseModel):
    ...
    """ # noqa: E501
    provider: StrictStr
    domain: StrictStr = Field(description="Email domain for SSO routing")
    entity_id: Optional[StrictStr] = Field(default=None, description="SAML entity ID or OIDC issuer")
    sso_url: Optional[StrictStr] = None
    certificate: Optional[StrictStr] = Field(default=None, description="PEM-encoded X.509 certificate (SAML)")
    __properties: ClassVar[List[str]] = ["provider", "domain", "entity_id", "sso_url", "certificate"]

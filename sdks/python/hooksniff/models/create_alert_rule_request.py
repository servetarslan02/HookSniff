...
class CreateAlertRuleRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Human-readable alert name")
    condition: StrictStr = Field(description="Condition that triggers the alert")
    threshold: StrictInt = Field(description="Threshold value for the condition")
    channels: List[StrictStr] = Field(description="Notification channels to alert on")

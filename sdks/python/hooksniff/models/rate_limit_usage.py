...
class RateLimitUsage(BaseModel):
    ...
    """ # noqa: E501
    current_rps: Union[StrictFloat, StrictInt] = Field(description="Current requests per second being consumed")
    limit_rps: Union[StrictFloat, StrictInt] = Field(description="Configured requests per second limit")
    remaining: Union[StrictFloat, StrictInt] = Field(description="Remaining capacity")
    reset_at: datetime
    __properties: ClassVar[List[str]] = ["current_rps", "limit_rps", "remaining", "reset_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current_rps": obj.get("current_rps"),
            "limit_rps": obj.get("limit_rps"),

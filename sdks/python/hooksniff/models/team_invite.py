...
class TeamInvite(BaseModel):
    ...
    role: StrictStr
    created_at: datetime
    __properties: ClassVar[List[str]] = ["id", "email", "role", "created_at"]
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, TeamInvite)

    @staticmethod
    def _from_json(data: dict) -> "TeamInvite":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, TeamInvite)

...
class AnalyticsTrendResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[AnalyticsTrendPoint] = Field(description="Array of trend data points")
    period: StrictStr = Field(description="Time range of the data")
    __properties: ClassVar[List[str]] = ["data", "period"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AnalyticsTrendPoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, AnalyticsTrendResponse)

    @staticmethod
    def _from_json(data: dict) -> "AnalyticsTrendResponse":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, AnalyticsTrendResponse)

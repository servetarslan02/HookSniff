...
class PortalNotificationsPut200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "preferences": NotificationPreferences.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None
        })
        return _obj

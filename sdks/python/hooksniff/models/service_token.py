...
class ServiceToken(BaseModel):
    ...
    token_prefix: Optional[StrictStr] = Field(default=None, description="Token prefix (first 24 chars + ...)")
    created_at: Optional[datetime] = None
    last_used_at: Optional[datetime] = None
    is_active: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "token_prefix", "created_at", "last_used_at", "is_active"]

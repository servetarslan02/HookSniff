...
class AlertNotificationListResponse(BaseModel):
    ...
    """ # noqa: E501
    data: List[AlertNotificationListResponseDataInner]
    has_more: StrictBool
    total: StrictInt
    __properties: ClassVar[List[str]] = ["data", "has_more", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AlertNotificationListResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,

...
class LatencyTrendResponseBucketsInner(BaseModel):
    """
    LatencyTrendResponseBucketsInner
    """ # noqa: E501
    timestamp: Optional[StrictStr] = None
    avg_ms: Optional[Union[StrictFloat, StrictInt]] = None
    p95_ms: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["timestamp", "avg_ms", "p95_ms"]

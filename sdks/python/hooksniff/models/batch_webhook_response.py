...
class BatchWebhookResponse(BaseModel):
    ...
    """ # noqa: E501
    delivery_ids: List[UUID] = Field(description="List of created delivery IDs")
    count: StrictInt = Field(description="Number of deliveries created")
    __properties: ClassVar[List[str]] = ["delivery_ids", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "delivery_ids": obj.get("delivery_ids"),
            "count": obj.get("count")
        })
        return _obj
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, BatchWebhookResponse)

    @staticmethod
    def _from_json(data: dict) -> "BatchWebhookResponse":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, BatchWebhookResponse)

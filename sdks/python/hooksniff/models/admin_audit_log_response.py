...
class AdminAuditLogResponse(BaseModel):
    ...
    page: StrictInt
    per_page: StrictInt
    __properties: ClassVar[List[str]] = ["entries", "total", "page", "per_page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [AdminAuditEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),

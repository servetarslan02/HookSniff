...
class PlaygroundTestRequest(BaseModel):
    ...
    """ # noqa: E501
    endpoint_id: UUID
    payload: Dict[str, Any] = Field(description="The payload to send")
    headers: Optional[Dict[str, Any]] = Field(default=None, description="Custom headers to include with the request")
    __properties: ClassVar[List[str]] = ["endpoint_id", "payload", "headers"]

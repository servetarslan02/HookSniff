...
class InboundWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    provider: StrictStr = Field(description="Provider name (e.g. stripe, github, shopify)")
    payload: Dict[str, Any] = Field(description="Raw webhook payload body")
    headers: Optional[Dict[str, Any]] = Field(default=None, description="HTTP headers from the incoming webhook request")
    __properties: ClassVar[List[str]] = ["provider", "payload", "headers"]

...
class AdminRevenueEntry(BaseModel):
    ...
    mrr: Union[StrictFloat, StrictInt] = Field(description="Monthly recurring revenue in dollars")
    new_subscriptions: StrictInt
    churns: StrictInt
    __properties: ClassVar[List[str]] = ["date", "mrr", "new_subscriptions", "churns"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "mrr": obj.get("mrr"),
            "new_subscriptions": obj.get("new_subscriptions"),
            "churns": obj.get("churns")
        })
        return _obj

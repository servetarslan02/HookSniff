...
class EmbedConfig(BaseModel):
    ...
    """ # noqa: E501
    allowed_origins: List[StrictStr] = Field(description="CORS origins allowed to load the embed")
    theme: Optional[EmbedConfigTheme] = None
    features: Optional[List[StrictStr]] = Field(default=None, description="Enabled features (e.g. [deliveries, endpoints, playground])")
    __properties: ClassVar[List[str]] = ["allowed_origins", "theme", "features"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "theme": EmbedConfigTheme.from_dict(obj["theme"]) if obj.get("theme") is not None else None,

...
class Endpoint(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if allowed_ips (nullable) is None
        # and model_fields_set contains the field
        if self.allowed_ips is None and "allowed_ips" in self.model_fields_set:
            _dict['allowed_ips'] = None

        # set to None if event_filter (nullable) is None
        # and model_fields_set contains the field
        if self.event_filter is None and "event_filter" in self.model_fields_set:
            _dict['event_filter'] = None
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, Endpoint)

    @staticmethod
    def _from_json(data: dict) -> "Endpoint":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, Endpoint)

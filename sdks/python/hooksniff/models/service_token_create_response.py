...
class ServiceTokenCreateResponse(BaseModel):
    ...
    token: Optional[StrictStr] = Field(default=None, description="Full token value (only shown once)")
    token_prefix: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "name", "token", "token_prefix", "message"]

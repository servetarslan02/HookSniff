...
class ValidateEventResponseErrorsInner(BaseModel):
    """
    ValidateEventResponseErrorsInner
    """ # noqa: E501
    path: Optional[StrictStr] = Field(default=None, description="JSON pointer to the failing field")
    message: Optional[StrictStr] = Field(default=None, description="Human-readable validation error")

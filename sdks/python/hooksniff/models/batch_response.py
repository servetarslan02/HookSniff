...
class BatchResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [BatchResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, BatchResponse)

    @staticmethod
    def _from_json(data: dict) -> "BatchResponse":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, BatchResponse)

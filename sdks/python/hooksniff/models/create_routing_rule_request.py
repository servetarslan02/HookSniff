...
class CreateRoutingRuleRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr
    conditions: Dict[str, Any] = Field(description="Conditions that trigger this rule (e.g. event_type, header match)")
    transform: Optional[Dict[str, Any]] = Field(default=None, description="Optional payload transformation config")
    target_endpoint_id: UUID
    __properties: ClassVar[List[str]] = ["name", "conditions", "transform", "target_endpoint_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "target_endpoint_id": obj.get("target_endpoint_id")
        })
        return _obj

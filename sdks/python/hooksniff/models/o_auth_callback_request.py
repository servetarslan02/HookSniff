...
class OAuthCallbackRequest(BaseModel):
    ...
    """ # noqa: E501
    code: StrictStr = Field(description="Authorization code from the provider")
    state: StrictStr = Field(description="CSRF state token")
    redirect_uri: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["code", "state", "redirect_uri"]

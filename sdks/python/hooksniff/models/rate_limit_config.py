...
class RateLimitConfig(BaseModel):
    ...
    """ # noqa: E501
    requests_per_second: StrictInt = Field(description="Maximum requests per second allowed")
    burst_size: StrictInt = Field(description="Maximum burst above steady-state rate")
    enabled: StrictBool
    __properties: ClassVar[List[str]] = ["requests_per_second", "burst_size", "enabled"]

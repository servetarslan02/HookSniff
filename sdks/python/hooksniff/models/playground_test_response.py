...
class PlaygroundTestResponse(BaseModel):
    ...
    """ # noqa: E501
    status_code: StrictInt = Field(description="HTTP status code returned by the endpoint")
    response_body: StrictStr = Field(description="Raw response body from the endpoint")
    latency_ms: StrictInt
    headers: Optional[Dict[str, Any]] = Field(default=None, description="Response headers from the endpoint")
    __properties: ClassVar[List[str]] = ["status_code", "response_body", "latency_ms", "headers"]

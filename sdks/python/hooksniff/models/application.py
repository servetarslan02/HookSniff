...
class Application(BaseModel):
    ...
    endpoint_count: Optional[StrictInt] = None
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["id", "customer_id", "name", "description", "is_active", "endpoint_count", "created_at", "updated_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "endpoint_count": obj.get("endpoint_count"),

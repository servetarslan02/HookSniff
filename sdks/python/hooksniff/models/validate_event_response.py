...
class ValidateEventResponse(BaseModel):
    ...
    """ # noqa: E501
    valid: StrictBool
    errors: Optional[List[ValidateEventResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "valid": obj.get("valid"),
            "errors": [ValidateEventResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj

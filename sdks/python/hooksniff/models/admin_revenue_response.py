...
class AdminRevenueResponse(BaseModel):
    ...
    total_mrr: Union[StrictFloat, StrictInt] = Field(description="Current total MRR across all subscriptions")
    __properties: ClassVar[List[str]] = ["data", "total_mrr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [AdminRevenueEntry.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total_mrr": obj.get("total_mrr")
        })
        return _obj

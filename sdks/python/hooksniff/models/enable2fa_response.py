...
class Enable2faResponse(BaseModel):
    ...
    """ # noqa: E501
    secret: StrictStr = Field(description="TOTP secret key")
    qr_url: StrictStr = Field(description="QR code provisioning URL")
    __properties: ClassVar[List[str]] = ["secret", "qr_url"]

...
class LatencyTrendResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "range": obj.get("range"),
            "buckets": [LatencyTrendResponseBucketsInner.from_dict(_item) for _item in obj["buckets"]] if obj.get("buckets") is not None else None,
            "overall_avg_ms": obj.get("overall_avg_ms")
        })
        return _obj

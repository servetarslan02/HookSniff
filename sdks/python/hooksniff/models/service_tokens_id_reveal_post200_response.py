...
class ServiceTokensIdRevealPost200Response(BaseModel):
    """
    ServiceTokensIdRevealPost200Response
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Full token value (null if not available)")
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["token", "message"]

...
class CreateWebhookRequest(BaseModel):
    ...
    """ # noqa: E501
    endpoint_id: UUID
    event: Optional[StrictStr] = Field(default=None, description="Event type (e.g. \"order.created\")")
    data: Dict[str, Any] = Field(description="Webhook payload")
    __properties: ClassVar[List[str]] = ["endpoint_id", "event", "data"]
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, CreateWebhookRequest)

    @staticmethod
    def _from_json(data: dict) -> "CreateWebhookRequest":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, CreateWebhookRequest)

...
class EndpointListResponse(BaseModel):
    ...
    total: StrictInt
    has_more: StrictBool
    __properties: ClassVar[List[str]] = ["data", "total", "has_more"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Endpoint.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, EndpointListResponse)

    @staticmethod
    def _from_json(data: dict) -> "EndpointListResponse":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, EndpointListResponse)

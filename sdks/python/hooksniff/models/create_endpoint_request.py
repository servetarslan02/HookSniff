...
class CreateEndpointRequest(BaseModel):
    ...
    format: Optional[StrictStr] = 'standard'
    __properties: ClassVar[List[str]] = ["url", "description", "allowed_ips", "event_filter", "custom_headers", "retry_policy", "routing_strategy", "fallback_url", "format"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "format": obj.get("format") if obj.get("format") is not None else 'standard'
        })
        return _obj

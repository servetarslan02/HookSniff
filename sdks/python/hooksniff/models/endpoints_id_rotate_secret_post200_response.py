...
class EndpointsIdRotateSecretPost200Response(BaseModel):
    """
    EndpointsIdRotateSecretPost200Response
    """ # noqa: E501
    signing_secret: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["signing_secret", "message"]
    ...
    def _to_json(obj: dict) -> dict:
        ...
        return _to_json_static(obj, EndpointsIdRotateSecretPost200Response)

    @staticmethod
    def _from_json(data: dict) -> "EndpointsIdRotateSecretPost200Response":
        """Deserialize from JSON dict. Validates required, applies defaults, ignores extras."""
        return _from_json_static(data, EndpointsIdRotateSecretPost200Response)

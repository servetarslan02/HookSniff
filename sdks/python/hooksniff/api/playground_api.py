...
class PlaygroundApi:
    ...
    def playground_get(
        ...
        _param = self._playground_get_serialize(
    ...
    @validate_call
    def playground_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PlaygroundGet200Response]:
        """Get playground info (endpoints, sample payloads)
    ...
    @validate_call
    def playground_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def playground_test_post(
        ...
        _param = self._playground_test_post_serialize(
    ...
    @validate_call
    def playground_test_post_with_http_info(
        self,
        test_webhook_request: TestWebhookRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def playground_test_post_without_preload_content(
        self,
        test_webhook_request: TestWebhookRequest,
        _request_timeout: Union[
            None,
    ...
    def _playground_test_post_serialize(
        self,

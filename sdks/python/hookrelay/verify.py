...
def verify_signature(payload: str, signature: str, secret: str) -> bool:
    ...
    Example:
        >>> from hookrelay.verify import verify_signature
...
def verify_webhook_request(request, secret: str) -> WebhookEvent:
    ...
    Example:
        ...
        from hookrelay.verify import verify_webhook_request
    ...
    legacy_sig = _get_header(headers, "x-hookrelay-signature")
    if not legacy_sig:
...
class WebhookHandler:
    ...
    Example (Flask):
        ...
        from hookrelay.verify import WebhookHandler, WebhookEvent

...
class TestUpdateNotificationPreferences(unittest.TestCase):
    """UpdateNotificationPreferences unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateNotificationPreferences:

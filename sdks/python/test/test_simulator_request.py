...
class TestSimulatorRequest(unittest.TestCase):
    """SimulatorRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimulatorRequest:

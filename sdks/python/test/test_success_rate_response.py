...
class TestSuccessRateResponse(unittest.TestCase):
    """SuccessRateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuccessRateResponse:
    ...
    def testSuccessRateResponse(self):
        """Test SuccessRateResponse"""

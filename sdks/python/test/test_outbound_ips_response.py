...
class TestOutboundIPsResponse(unittest.TestCase):
    """OutboundIPsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutboundIPsResponse:
    ...
    def testOutboundIPsResponse(self):
        """Test OutboundIPsResponse"""

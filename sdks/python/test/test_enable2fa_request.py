...
class TestEnable2faRequest(unittest.TestCase):
    """Enable2faRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Enable2faRequest:
        """Test Enable2faRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Enable2faRequest`
        """
        model = Enable2faRequest()
        if include_optional:

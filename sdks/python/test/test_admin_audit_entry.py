...
class TestAdminAuditEntry(unittest.TestCase):
    """AdminAuditEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminAuditEntry:

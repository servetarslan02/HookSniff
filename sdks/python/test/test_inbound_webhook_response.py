...
class TestInboundWebhookResponse(unittest.TestCase):
    """InboundWebhookResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InboundWebhookResponse:
    ...
    def testInboundWebhookResponse(self):
        """Test InboundWebhookResponse"""

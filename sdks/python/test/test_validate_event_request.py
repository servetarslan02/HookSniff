...
class TestValidateEventRequest(unittest.TestCase):
    """ValidateEventRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateEventRequest:
    ...
    def testValidateEventRequest(self):
        """Test ValidateEventRequest"""

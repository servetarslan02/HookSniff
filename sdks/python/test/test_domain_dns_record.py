...
class TestDomainDnsRecord(unittest.TestCase):
    """DomainDnsRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainDnsRecord:

...
*AdminApi* | [**adminRevenueGet**](docs/Api/AdminApi.md#adminrevenueget) | **GET** /admin/revenue | Revenue by month (admin)
...
*RoutingApi* | [**routingIdHealthGet**](docs/Api/RoutingApi.md#routingidhealthget) | **GET** /routing/{id}/health | Get endpoint health status
*RoutingApi* | [**routingIdRoutingGet**](docs/Api/RoutingApi.md#routingidroutingget) | **GET** /routing/{id}/routing | Get routing config for endpoint
*RoutingApi* | [**routingIdRoutingPut**](docs/Api/RoutingApi.md#routingidroutingput) | **PUT** /routing/{id}/routing | Update routing config
...
- [AdminRevenueGet200ResponseInner](docs/Model/AdminRevenueGet200ResponseInner.md)

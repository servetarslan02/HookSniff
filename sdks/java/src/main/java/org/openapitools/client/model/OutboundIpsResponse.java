...
public class OutboundIpsResponse {
  ...
  public OutboundIpsResponse ips(@javax.annotation.Nullable List<String> ips) {
    this.ips = ips;
    return this;
  }
  ...
  public OutboundIpsResponse updatedAt(@javax.annotation.Nullable String updatedAt) {

...
api_instance = HooksniffSdk::TemplatesApi.new
opts = {
...
apply_template_request = HooksniffSdk::ApplyTemplateRequest.new({endpoint_id: 'endpoint_id_example'}) # ApplyTemplateRequest | 

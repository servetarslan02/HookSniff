...
api_instance = HooksniffSdk::CustomDomainsApi.new
...
api_instance = HooksniffSdk::CustomDomainsApi.new
opts = {
  custom_domains_post_request: HooksniffSdk::CustomDomainsPostRequest.new # CustomDomainsPostRequest | 
}

...
api_instance = HooksniffSdk::EndpointsApi.new
...
api_instance = HooksniffSdk::EndpointsApi.new
id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # String | 
update_endpoint_request = HooksniffSdk::UpdateEndpointRequest.new({url: 'url_example', description: 'description_example', is_active: false, allowed_ips: ['allowed_ips_example'], event_filter: ['event_filter_example'], retry_policy: HooksniffSdk::RetryPolicy.new({max_attempts: 37, backoff: 'exponential', initial_delay_secs: 37, max_delay_secs: 37}), routing_strategy: 'round-robin', fallback_url: 'fallback_url_example', format: 'standard'}) # UpdateEndpointRequest | 
...
api_instance = HooksniffSdk::EndpointsApi.new
id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # String | 
retry_policy = HooksniffSdk::RetryPolicy.new({max_attempts: 37, backoff: 'exponential', initial_delay_secs: 37, max_delay_secs: 37}) # RetryPolicy | 
...
api_instance = HooksniffSdk::EndpointsApi.new
create_endpoint_request = HooksniffSdk::CreateEndpointRequest.new({url: 'url_example'}) # CreateEndpointRequest | 

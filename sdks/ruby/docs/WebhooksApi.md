...
api_instance = HooksniffSdk::WebhooksApi.new
batch_webhook_request = HooksniffSdk::BatchWebhookRequest.new({webhooks: [HooksniffSdk::CreateWebhookRequest.new({endpoint_id: 'endpoint_id_example', data: 3.56})]}) # BatchWebhookRequest | 
...
api_instance = HooksniffSdk::WebhooksApi.new
batch_replay_request = HooksniffSdk::BatchReplayRequest.new({ids: ['ids_example']}) # BatchReplayRequest | 
...
api_instance = HooksniffSdk::WebhooksApi.new
create_webhook_request = HooksniffSdk::CreateWebhookRequest.new({endpoint_id: 'endpoint_id_example', data: 3.56}) # CreateWebhookRequest | 

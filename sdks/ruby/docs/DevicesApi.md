...
api_instance = HooksniffSdk::DevicesApi.new
...
api_instance = HooksniffSdk::DevicesApi.new
register_device_request = HooksniffSdk::RegisterDeviceRequest.new({token: 'token_example'}) # RegisterDeviceRequest | 

...
api_instance = HooksniffSdk::RoutingApi.new
...
api_instance = HooksniffSdk::RoutingApi.new
id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # String | 
update_routing_request = HooksniffSdk::UpdateRoutingRequest.new({routing_strategy: 'round-robin', fallback_url: 'fallback_url_example'}) # UpdateRoutingRequest | 

...
# Unit tests for OpenapiClient::TransformRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TransformRule do
  #let(:instance) { OpenapiClient::TransformRule.new }

  describe 'test an instance of TransformRule' do
    it 'should create an instance of TransformRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TransformRule)
    end
  end

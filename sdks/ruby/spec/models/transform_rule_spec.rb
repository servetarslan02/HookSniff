...
# Unit tests for HooksniffSdk::TransformRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::TransformRule do
  #let(:instance) { HooksniffSdk::TransformRule.new }

  describe 'test an instance of TransformRule' do
    it 'should create an instance of TransformRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::TransformRule)
    end
  end

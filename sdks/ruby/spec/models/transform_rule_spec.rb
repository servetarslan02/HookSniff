...
# Unit tests for HookSniff::TransformRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::TransformRule do
  #let(:instance) { HookSniff::TransformRule.new }

  describe 'test an instance of TransformRule' do
    it 'should create an instance of TransformRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::TransformRule)
    end
  end

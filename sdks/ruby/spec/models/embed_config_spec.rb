...
# Unit tests for HookSniff::EmbedConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::EmbedConfig do
  #let(:instance) { HookSniff::EmbedConfig.new }

  describe 'test an instance of EmbedConfig' do
    it 'should create an instance of EmbedConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::EmbedConfig)
    end
  end

...
# Unit tests for OpenapiClient::ApiKeyInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ApiKeyInfo do
  #let(:instance) { OpenapiClient::ApiKeyInfo.new }

  describe 'test an instance of ApiKeyInfo' do
    it 'should create an instance of ApiKeyInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ApiKeyInfo)
    end
  end

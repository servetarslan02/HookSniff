...
# Unit tests for HooksniffSdk::ChangePasswordRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::ChangePasswordRequest do
  #let(:instance) { HooksniffSdk::ChangePasswordRequest.new }

  describe 'test an instance of ChangePasswordRequest' do
    it 'should create an instance of ChangePasswordRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::ChangePasswordRequest)
    end
  end

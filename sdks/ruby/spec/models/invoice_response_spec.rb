...
# Unit tests for OpenapiClient::InvoiceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::InvoiceResponse do
  #let(:instance) { OpenapiClient::InvoiceResponse.new }

  describe 'test an instance of InvoiceResponse' do
    it 'should create an instance of InvoiceResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::InvoiceResponse)
    end
  end

...
# Unit tests for HooksniffSdk::InvoiceResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::InvoiceResponse do
  #let(:instance) { HooksniffSdk::InvoiceResponse.new }

  describe 'test an instance of InvoiceResponse' do
    it 'should create an instance of InvoiceResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::InvoiceResponse)
    end
  end

...
# Unit tests for HookSniff::ContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::ContactRequest do
  #let(:instance) { HookSniff::ContactRequest.new }

  describe 'test an instance of ContactRequest' do
    it 'should create an instance of ContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::ContactRequest)
    end
  end

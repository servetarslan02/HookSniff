...
# Unit tests for OpenapiClient::ContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ContactRequest do
  #let(:instance) { OpenapiClient::ContactRequest.new }

  describe 'test an instance of ContactRequest' do
    it 'should create an instance of ContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ContactRequest)
    end
  end

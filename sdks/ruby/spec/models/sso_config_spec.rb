...
# Unit tests for HooksniffSdk::SSOConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::SSOConfig do
  #let(:instance) { HooksniffSdk::SSOConfig.new }

  describe 'test an instance of SSOConfig' do
    it 'should create an instance of SSOConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::SSOConfig)
    end
  end

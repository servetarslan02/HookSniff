...
# Unit tests for HookSniff::SSOConfig
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::SSOConfig do
  #let(:instance) { HookSniff::SSOConfig.new }

  describe 'test an instance of SSOConfig' do
    it 'should create an instance of SSOConfig' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::SSOConfig)
    end
  end

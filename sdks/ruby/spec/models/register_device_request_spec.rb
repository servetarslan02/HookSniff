...
# Unit tests for HookSniff::RegisterDeviceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::RegisterDeviceRequest do
  #let(:instance) { HookSniff::RegisterDeviceRequest.new }

  describe 'test an instance of RegisterDeviceRequest' do
    it 'should create an instance of RegisterDeviceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::RegisterDeviceRequest)
    end
  end

...
# Unit tests for OpenapiClient::EventTypeListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventTypeListResponse do
  #let(:instance) { OpenapiClient::EventTypeListResponse.new }

  describe 'test an instance of EventTypeListResponse' do
    it 'should create an instance of EventTypeListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EventTypeListResponse)
    end
  end

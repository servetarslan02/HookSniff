...
# Unit tests for HookSniff::EventTypeListResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::EventTypeListResponse do
  #let(:instance) { HookSniff::EventTypeListResponse.new }

  describe 'test an instance of EventTypeListResponse' do
    it 'should create an instance of EventTypeListResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::EventTypeListResponse)
    end
  end

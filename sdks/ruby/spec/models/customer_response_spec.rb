...
# Unit tests for HookSniff::CustomerResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::CustomerResponse do
  #let(:instance) { HookSniff::CustomerResponse.new }

  describe 'test an instance of CustomerResponse' do
    it 'should create an instance of CustomerResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::CustomerResponse)
    end
  end

...
# Unit tests for OpenapiClient::CancelSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CancelSubscriptionRequest do
  #let(:instance) { OpenapiClient::CancelSubscriptionRequest.new }
  ...
  describe 'test an instance of CancelSubscriptionRequest' do
    it 'should create an instance of CancelSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::CancelSubscriptionRequest)
    end
  end

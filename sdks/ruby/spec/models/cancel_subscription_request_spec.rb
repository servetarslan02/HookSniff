...
# Unit tests for HooksniffSdk::CancelSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::CancelSubscriptionRequest do
  #let(:instance) { HooksniffSdk::CancelSubscriptionRequest.new }
  ...
  describe 'test an instance of CancelSubscriptionRequest' do
    it 'should create an instance of CancelSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(HooksniffSdk::CancelSubscriptionRequest)
    end
  end

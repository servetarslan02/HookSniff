...
# Unit tests for HookSniff::CancelSubscriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::CancelSubscriptionRequest do
  #let(:instance) { HookSniff::CancelSubscriptionRequest.new }
  ...
  describe 'test an instance of CancelSubscriptionRequest' do
    it 'should create an instance of CancelSubscriptionRequest' do
      ...
      #expect(instance).to be_instance_of(HookSniff::CancelSubscriptionRequest)
    end
  end

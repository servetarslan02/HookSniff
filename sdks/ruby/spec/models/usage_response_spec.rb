...
# Unit tests for HooksniffSdk::UsageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::UsageResponse do
  #let(:instance) { HooksniffSdk::UsageResponse.new }

  describe 'test an instance of UsageResponse' do
    it 'should create an instance of UsageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::UsageResponse)
    end
  end

...
# Unit tests for HookSniff::UsageResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::UsageResponse do
  #let(:instance) { HookSniff::UsageResponse.new }

  describe 'test an instance of UsageResponse' do
    it 'should create an instance of UsageResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::UsageResponse)
    end
  end

...
# Unit tests for HooksniffSdk::DeliveryDetailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::DeliveryDetailResponse do
  #let(:instance) { HooksniffSdk::DeliveryDetailResponse.new }

  describe 'test an instance of DeliveryDetailResponse' do
    it 'should create an instance of DeliveryDetailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::DeliveryDetailResponse)
    end
  end

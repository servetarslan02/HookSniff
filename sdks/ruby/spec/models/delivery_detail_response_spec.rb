...
# Unit tests for HookSniff::DeliveryDetailResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::DeliveryDetailResponse do
  #let(:instance) { HookSniff::DeliveryDetailResponse.new }

  describe 'test an instance of DeliveryDetailResponse' do
    it 'should create an instance of DeliveryDetailResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::DeliveryDetailResponse)
    end
  end

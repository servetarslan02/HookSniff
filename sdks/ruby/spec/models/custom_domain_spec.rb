...
# Unit tests for HookSniff::CustomDomain
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::CustomDomain do
  #let(:instance) { HookSniff::CustomDomain.new }

  describe 'test an instance of CustomDomain' do
    it 'should create an instance of CustomDomain' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::CustomDomain)
    end
  end

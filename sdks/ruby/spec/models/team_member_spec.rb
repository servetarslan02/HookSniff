...
# Unit tests for OpenapiClient::TeamMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TeamMember do
  #let(:instance) { OpenapiClient::TeamMember.new }

  describe 'test an instance of TeamMember' do
    it 'should create an instance of TeamMember' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TeamMember)
    end
  end

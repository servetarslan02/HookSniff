...
# Unit tests for HooksniffSdk::TeamMember
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::TeamMember do
  #let(:instance) { HooksniffSdk::TeamMember.new }

  describe 'test an instance of TeamMember' do
    it 'should create an instance of TeamMember' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::TeamMember)
    end
  end

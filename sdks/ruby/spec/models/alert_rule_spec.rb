...
# Unit tests for HooksniffSdk::AlertRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::AlertRule do
  #let(:instance) { HooksniffSdk::AlertRule.new }

  describe 'test an instance of AlertRule' do
    it 'should create an instance of AlertRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::AlertRule)
    end
  end

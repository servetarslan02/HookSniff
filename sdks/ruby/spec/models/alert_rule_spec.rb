...
# Unit tests for HookSniff::AlertRule
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::AlertRule do
  #let(:instance) { HookSniff::AlertRule.new }

  describe 'test an instance of AlertRule' do
    it 'should create an instance of AlertRule' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::AlertRule)
    end
  end

...
# Unit tests for HookSniff::InviteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::InviteRequest do
  #let(:instance) { HookSniff::InviteRequest.new }

  describe 'test an instance of InviteRequest' do
    it 'should create an instance of InviteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::InviteRequest)
    end
  end

...
# Unit tests for HooksniffSdk::InviteRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::InviteRequest do
  #let(:instance) { HooksniffSdk::InviteRequest.new }

  describe 'test an instance of InviteRequest' do
    it 'should create an instance of InviteRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::InviteRequest)
    end
  end

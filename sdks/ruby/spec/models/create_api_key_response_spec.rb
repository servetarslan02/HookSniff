...
# Unit tests for OpenapiClient::CreateApiKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateApiKeyResponse do
  #let(:instance) { OpenapiClient::CreateApiKeyResponse.new }

  describe 'test an instance of CreateApiKeyResponse' do
    it 'should create an instance of CreateApiKeyResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateApiKeyResponse)
    end
  end

...
# Unit tests for HookSniff::CreateApiKeyResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::CreateApiKeyResponse do
  #let(:instance) { HookSniff::CreateApiKeyResponse.new }

  describe 'test an instance of CreateApiKeyResponse' do
    it 'should create an instance of CreateApiKeyResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::CreateApiKeyResponse)
    end
  end

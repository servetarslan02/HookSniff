...
# Unit tests for HookSniff::SearchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::SearchRequest do
  #let(:instance) { HookSniff::SearchRequest.new }

  describe 'test an instance of SearchRequest' do
    it 'should create an instance of SearchRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::SearchRequest)
    end
  end

...
# Unit tests for HookSniff::RetryPolicy
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::RetryPolicy do
  #let(:instance) { HookSniff::RetryPolicy.new }

  describe 'test an instance of RetryPolicy' do
    it 'should create an instance of RetryPolicy' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::RetryPolicy)
    end
  end

...
# Unit tests for HookSniff::Notification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::Notification do
  #let(:instance) { HookSniff::Notification.new }

  describe 'test an instance of Notification' do
    it 'should create an instance of Notification' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::Notification)
    end
  end

...
# Unit tests for HooksniffSdk::AuditLogEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::AuditLogEntry do
  #let(:instance) { HooksniffSdk::AuditLogEntry.new }

  describe 'test an instance of AuditLogEntry' do
    it 'should create an instance of AuditLogEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::AuditLogEntry)
    end
  end

...
# Unit tests for HookSniff::AuditLogEntry
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::AuditLogEntry do
  #let(:instance) { HookSniff::AuditLogEntry.new }

  describe 'test an instance of AuditLogEntry' do
    it 'should create an instance of AuditLogEntry' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::AuditLogEntry)
    end
  end

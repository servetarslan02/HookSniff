...
# Unit tests for HooksniffSdk::SchemaResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::SchemaResponse do
  #let(:instance) { HooksniffSdk::SchemaResponse.new }

  describe 'test an instance of SchemaResponse' do
    it 'should create an instance of SchemaResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::SchemaResponse)
    end
  end

...
# Unit tests for OpenapiClient::SchemaResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SchemaResponse do
  #let(:instance) { OpenapiClient::SchemaResponse.new }

  describe 'test an instance of SchemaResponse' do
    it 'should create an instance of SchemaResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SchemaResponse)
    end
  end
  ...
  describe 'test attribute "schema_json"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

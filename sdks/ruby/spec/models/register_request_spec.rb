...
# Unit tests for HooksniffSdk::RegisterRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::RegisterRequest do
  #let(:instance) { HooksniffSdk::RegisterRequest.new }

  describe 'test an instance of RegisterRequest' do
    it 'should create an instance of RegisterRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::RegisterRequest)
    end
  end

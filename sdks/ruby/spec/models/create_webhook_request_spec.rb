...
# Unit tests for HookSniff::CreateWebhookRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::CreateWebhookRequest do
  #let(:instance) { HookSniff::CreateWebhookRequest.new }

  describe 'test an instance of CreateWebhookRequest' do
    it 'should create an instance of CreateWebhookRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::CreateWebhookRequest)
    end
  end

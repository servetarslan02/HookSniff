...
# Unit tests for HookSniff::TestWebhookResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::TestWebhookResponse do
  #let(:instance) { HookSniff::TestWebhookResponse.new }

  describe 'test an instance of TestWebhookResponse' do
    it 'should create an instance of TestWebhookResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::TestWebhookResponse)
    end
  end

...
# Unit tests for HooksniffSdk::AuthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::AuthResponse do
  #let(:instance) { HooksniffSdk::AuthResponse.new }

  describe 'test an instance of AuthResponse' do
    it 'should create an instance of AuthResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::AuthResponse)
    end
  end

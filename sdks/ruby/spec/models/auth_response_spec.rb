...
# Unit tests for HookSniff::AuthResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::AuthResponse do
  #let(:instance) { HookSniff::AuthResponse.new }

  describe 'test an instance of AuthResponse' do
    it 'should create an instance of AuthResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::AuthResponse)
    end
  end

...
# Unit tests for HookSniff::LoginRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::LoginRequest do
  #let(:instance) { HookSniff::LoginRequest.new }

  describe 'test an instance of LoginRequest' do
    it 'should create an instance of LoginRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::LoginRequest)
    end
  end

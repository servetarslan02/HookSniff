...
# Unit tests for HookSniff::SuccessRateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::SuccessRateResponse do
  #let(:instance) { HookSniff::SuccessRateResponse.new }

  describe 'test an instance of SuccessRateResponse' do
    it 'should create an instance of SuccessRateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::SuccessRateResponse)
    end
  end

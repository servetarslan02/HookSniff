...
# Unit tests for HooksniffSdk::DeliveryAttempt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::DeliveryAttempt do
  #let(:instance) { HooksniffSdk::DeliveryAttempt.new }

  describe 'test an instance of DeliveryAttempt' do
    it 'should create an instance of DeliveryAttempt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::DeliveryAttempt)
    end
  end

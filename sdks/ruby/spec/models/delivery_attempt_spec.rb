...
# Unit tests for HookSniff::DeliveryAttempt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HookSniff::DeliveryAttempt do
  #let(:instance) { HookSniff::DeliveryAttempt.new }

  describe 'test an instance of DeliveryAttempt' do
    it 'should create an instance of DeliveryAttempt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HookSniff::DeliveryAttempt)
    end
  end

...
# Unit tests for HooksniffSdk::WebhookFilter
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe HooksniffSdk::WebhookFilter do
  #let(:instance) { HooksniffSdk::WebhookFilter.new }

  describe 'test an instance of WebhookFilter' do
    it 'should create an instance of WebhookFilter' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(HooksniffSdk::WebhookFilter)
    end
  end

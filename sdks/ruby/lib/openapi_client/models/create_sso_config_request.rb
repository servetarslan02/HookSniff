...
module OpenapiClient
  ...
  class CreateSSOConfigRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CreateSSOConfigRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CreateSSOConfigRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @metadata_url.nil?
        invalid_properties.push('invalid value for "metadata_url", metadata_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @metadata_url.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] metadata_url Value to be assigned
    def metadata_url=(metadata_url)
      if metadata_url.nil?
        fail ArgumentError, 'metadata_url cannot be nil'
      end
    ...
    def hash
      [provider, domain, metadata_url].hash
    end

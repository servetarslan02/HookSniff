  ...
  class TwoFactorRequiredResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `HooksniffSdk::TwoFactorRequiredResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `HooksniffSdk::TwoFactorRequiredResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @requires_2fa.nil?
        invalid_properties.push('invalid value for "requires_2fa", requires_2fa cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @requires_2fa.nil?
    ...
    # @param [Object] requires_2fa Value to be assigned
    def requires_2fa=(requires_2fa)
      if requires_2fa.nil?
        fail ArgumentError, 'requires_2fa cannot be nil'
      end

...
type _UpdateTeamRequest UpdateTeamRequest

// NewUpdateTeamRequest instantiates a new UpdateTeamRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateTeamRequest(name string, description string) *UpdateTeamRequest {
...
func (o *UpdateTeamRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateTeamRequest := _UpdateTeamRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateTeamRequest)

	if err != nil {
		return err
	}

	*o = UpdateTeamRequest(varUpdateTeamRequest)

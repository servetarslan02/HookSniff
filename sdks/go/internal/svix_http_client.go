...
func ExecuteRequest[ReqBody any, ResBody any](
	...
	req.Header.Set("hooksniff-req-id", strconv.FormatUint(rand.Uint64(), 10))
...
func executeRequestWithRetries(client *HookSniffHttpClient, request *http.Request) (*http.Response, error) {
	var bodyBytes []byte
	if request.Body != nil {
		var err error

...
export class ContactApi {
     ...
     */
    public async contactPost (contactRequest: ContactRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContactResponse;  }> {
        ...
        if (contactRequest === null || contactRequest === undefined) {
            throw new Error('Required parameter contactRequest was null or undefined when calling contactPost.');
        }

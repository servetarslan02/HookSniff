...
export const APIS = [APIKeysApi, AdminApi, AlertsApi, AnalyticsApi, AuditLogApi, AuthApi, BillingApi, ContactApi, CustomDomainsApi, CustomerPortalApi, DeliveryDetailsApi, DevicesApi, EmbedApi, EndpointsApi, EventsApi, HealthApi, InboundApi, NotificationsApi, OAuthApi, OutboundIPsApi, PlaygroundApi, RateLimitsApi, RoutingApi, SSOApi, SchemasApi, SearchApi, SimulatorApi, StatsApi, StreamApi, TeamsApi, TemplatesApi, TransformsApi, WebhooksApi];

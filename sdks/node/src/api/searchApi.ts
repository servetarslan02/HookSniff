...
export class SearchApi {
     ...
     * @param perPage 
     */
    public async searchGet (q: string, status?: string, endpointId?: string, page?: number, perPage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SearchResult;  }> {

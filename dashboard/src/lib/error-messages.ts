...
const CODE_MAP: Record<string, string> = {
  ...
  EMAIL_PROVIDER_NOT_CONFIGURED: 'email.providerNotConfigured',
  EMAIL_SEND_FAILED: 'email.sendFailed',
  ENDPOINT_ID_REQUIRED: 'endpoint.idRequired',
  INVALID_EMAIL: 'validation.invalidEmail',
  INVALID_PASSWORD: 'auth.invalidPassword',
  INVALID_USER_ID: 'validation.invalidUserId',
  INVALID_WEBHOOK_SIGNATURE: 'webhook.invalidSignature',
  MISSING_FIELD: 'validation.missingField',
  WEBHOOK_SIGNATURE_EXPIRED: 'webhook.signatureExpired',
  SCHEMA_NAME_REQUIRED: 'schema.nameRequired',
  BATCH_TOO_LARGE: 'webhook.batchTooLarge',
  BULK_REPLAY_DISABLED: 'webhook.bulkReplayDisabled',
  CUSTOM_RETRY_DISABLED: 'endpoint.customRetryDisabled',
  DEVICE_TOKEN_REQUIRED: 'device.tokenRequired',
  ...
  EMAIL_BODY_REQUIRED: 'email.bodyRequired',
  EMAIL_SUBJECT_REQUIRED: 'email.subjectRequired',
  INVALID_ALERT_CONDITION: 'alerts.invalidCondition',
  INVALID_NOTIFICATION_CHANNEL: 'notifications.invalidChannel',
  INVALID_NOTIFICATION_URL: 'notifications.invalidUrl',
  INVALID_RETENTION: 'validation.invalidRetention',
  INVALID_RETRY_ATTEMPTS: 'validation.invalidRetryAttempts',
  INVALID_THRESHOLD: 'validation.invalidThreshold',
  CHANNEL_DISABLED: 'notifications.channelDisabled',
  CSS_TOO_LARGE: 'portal.cssTooLarge',
  CSV_ONLY: 'import.csvOnly',
  TAG_EMPTY: 'validation.tagEmpty',

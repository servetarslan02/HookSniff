...
describe('RetryPolicyPage', () => {
  ...
  it('renders loading state initially', async () => {
    ...
    const { container } = renderWithProviders(<RetryPolicyPage />);
    expect(container.querySelector('.animate-pulse')).toBeTruthy();
  });

  it('renders the page header after loading', async () => {
    const { getByText } = renderWithProviders(<RetryPolicyPage />);
    await waitFor(() => {
  ...
  it('renders save button', async () => {
    const { getAllByText } = renderWithProviders(<RetryPolicyPage />);
    await waitFor(() => {
  ...
  it('renders max attempts input with default value 5', async () => {
    const { getAllByDisplayValue } = renderWithProviders(<RetryPolicyPage />);
    await waitFor(() => {
  ...
  it('fetches endpoints on mount', async () => {
    renderWithProviders(<RetryPolicyPage />);
    await waitFor(() => {

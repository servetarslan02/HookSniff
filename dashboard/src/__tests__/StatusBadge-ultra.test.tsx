...
describe('StatusBadge-ultra', () => {
  ...
  it('renders status text', () => {
    const { getByText } = renderWithProviders(<StatusBadge status="delivered" />);
    expect(getByText('delivered')).toBeTruthy();
  });

  // Test 2: Renders delivered status with green styling
  it('renders delivered with green styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="delivered" />);
  ...
  it('renders failed with red styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="failed" />);
    const badge = container.querySelector('span')!;
  ...
  it('renders inactive with gray styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="inactive" />);
    const badge = container.querySelector('span')!;
  ...
  it('renders banned with red styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="banned" />);
    const badge = container.querySelector('span')!;
    expect(badge.className).toContain('bg-red');
  });
  ...
  it('renders warning with amber styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="warning" />);
    const badge = container.querySelector('span')!;
    expect(badge.className).toContain('bg-amber');
  });
  ...
  it('renders success with green styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="success" />);
    const badge = container.querySelector('span')!;
    expect(badge.className).toContain('bg-emerald');
  });
  ...
  it('renders paid with green styling', () => {
    const { container } = renderWithProviders(<StatusBadge status="paid" />);
    const badge = container.querySelector('span')!;
    expect(badge.className).toContain('bg-emerald');
  });
  ...
  it('falls back to pending styling for unknown status', () => {
    const { container, getByText } = renderWithProviders(<StatusBadge status="unknown_status" />);
    const badge = container.querySelector('span')!;
    expect(badge.className).toContain('bg-amber');
  ...
  it('applies sm size classes', () => {
    const { container } = renderWithProviders(<StatusBadge status="delivered" size="sm" />);
    const badge = container.querySelector('span')!;
    expect(badge.className).toContain('text-xs');
  ...
  it('applies lg size classes', () => {
    const { container } = renderWithProviders(<StatusBadge status="delivered" size="lg" />);
    const badge = container.querySelector('span')!;
  ...
  it('applies custom className', () => {
    const { container } = renderWithProviders(<StatusBadge status="delivered" className="my-custom" />);
    const badge = container.querySelector('span')!;

export default function DocsPage() {
  return (
    <article className="prose prose-gray max-w-none">
      <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Getting Started</h1>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 mb-3">
              Sign up at <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">hookrelay.io</code> and grab your API key from the dashboard settings.
            </p>
          </div>

          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">2. Create an endpoint</h3>
            <p className="text-gray-600 mb-3">Register the URL where you want webhooks delivered:</p>
...
{`curl -X POST https://api.hookrelay.io/v1/endpoints \\
  ...
  -d '{"url": "https://myapp.com/webhook"}'`}
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">3. Send a webhook</h3>
            <pre className="bg-gray-900 text-green-400 p-4 rounded-xl text-sm font-mono overflow-x-auto">
{`curl -X POST https://api.hookrelay.io/v1/webhooks \\
  ...
  -d '{
    ...
    "data": {"order_id": "12345", "total": 99.99}
          ...
          <div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">4. Verify the signature</h3>
            <p className="text-gray-600 mb-3">Every webhook includes an HMAC-SHA256 signature in the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-sm">X-Hookrelay-Signature</code> header:</p>
            <pre className="bg-gray-900 text-green-400 p-4 rounded-xl text-sm font-mono overflow-x-auto">
{`import hmac, hashlib
...
def verify_signature(payload: bytes, signature: str, secret: str) -> bool:
    ...
    return hmac.compare_digest(f"sha256={expected}", signature)`}
      ...
      <section className="mb-12">
        ...
        <pre className="bg-gray-50 border border-gray-200 p-4 rounded-xl text-sm font-mono">
...
print('Delivery ID:', response.json()['id'])`}
        ...
        <h3 className="text-lg font-semibold text-gray-900 mb-3">Go</h3>
        <pre className="bg-gray-900 text-green-400 p-4 rounded-xl text-sm font-mono overflow-x-auto">
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium text-gray-700">Webhooks/month</th>
              </tr>
            </thead>

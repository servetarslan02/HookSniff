      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-3 mb-6">
            ...
            <span className="text-2xl font-bold text-gray-900">Hookrelay</span>
          </Link>
        ...
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === 'register' && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition"
                />
              </div>
            )}
            <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gray-900 text-white py-3 rounded-xl font-semibold hover:bg-gray-800 transition disabled:opacity-60 flex items-center justify-center gap-2"
            >

                  ...
                  <div className="space-y-2 max-h-[600px] overflow-y-auto">
                    {history.map((record) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between text-xs text-gray-400 dark:text-slate-600">
                ...
                {!selectedRecord ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-white dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-800">
                      ...
                      <span className="text-xs text-gray-400 dark:text-slate-600 ml-auto">{formatTime(selectedRecord.timestamp)}</span>
                    </div>

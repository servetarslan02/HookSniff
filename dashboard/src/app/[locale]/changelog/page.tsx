                    ...
                    <ul className="mt-1 space-y-0.5 ml-2">
                      {yearReleases.map((r) => (
                        <li key={r.version}>
                          ...
                          >
                            {r.version} <span className="text-gray-400 dark:text-slate-600">· {new Date(r.date).toLocaleString('en', { month: 'short' })}</span>
                          </a>
                        </li>
                      ))}
                    </ul>
                                  ...
                                  <div key={i} className="rounded-lg border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-3">
                                    <div className="flex items-start gap-3">
                                      ...
                                      <div className="flex-1 min-w-0">
                                        ...
                                        {entry.commit && (
                                          <a href={`https://github.com/servetarslan02/HookSniff/commit/${entry.commit}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 mt-1 text-xs font-mono text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors">

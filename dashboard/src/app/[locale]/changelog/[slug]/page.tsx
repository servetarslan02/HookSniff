      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-3 mt-4">
            <span className="text-xs text-gray-400 dark:text-slate-600">Share:</span>
            <a
              ...
              <div key={i} className="rounded-xl border border-gray-100 dark:border-slate-800 bg-white dark:bg-slate-900 p-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {entry.commit && (
                      <a href={`https://github.com/servetarslan02/HookSniff/commit/${entry.commit}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 mt-2 text-xs font-mono text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
        ...
        <div className="mt-16 pt-8 border-t border-gray-200 dark:border-slate-800 flex items-center justify-between">
          ...
          {nextRelease ? (
            <Link href={`/changelog/${nextRelease.slug}`} className="group text-right">
              <p className="text-xs text-gray-400 dark:text-slate-600 mb-1">Next →</p>
              <p className="text-sm font-medium text-gray-700 dark:text-slate-300 group-hover:text-brand-600 dark:group-hover:text-brand-400 transition-colors">

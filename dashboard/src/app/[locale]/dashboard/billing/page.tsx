    ...
    try {
      ...
      if (result.checkout_url) {
        ...
        if (trustedHosts.some(h => url.hostname === h || url.hostname.endsWith(`.${h}`))) {
          ...
          toast(t('invalidCheckoutUrl'), 'error');
        }
      } else {
    ...
    <div className="space-y-8">
      ...
      {showUpgradeModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
          <div aria-hidden="true" className="fixed inset-0 bg-black/40 backdrop-blur-sm" onClick={() => setShowUpgradeModal(null)} />
      ...
      {showCancelModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center" role="dialog" aria-modal="true">
          <div aria-hidden="true" className="fixed inset-0 bg-black/40 backdrop-blur-sm" onClick={() => { setShowCancelModal(false); setCancelling(false); }} />

      ...
      <nav className="border-b border-gray-200/50 dark:border-slate-700 bg-white/70 dark:bg-slate-800/70 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <ThemeToggleBtn />
            {token ? (
              <Link href="/" className="bg-gray-900 dark:bg-brand-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-gray-800 dark:hover:bg-brand-700 transition btn-glow">
                {tNav('dashboard')}
              </Link>
            ) : (
              <>
        ...
        {mobileNavOpen && (
          <div className="md:hidden border-t border-gray-200/50 dark:border-slate-700 bg-white/95 dark:bg-slate-800/95 backdrop-blur-xl px-6 py-4 space-y-3">
            ...
            <Link href="/" onClick={() => setMobileNavOpen(false)} className="block bg-gray-900 dark:bg-brand-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-gray-800 dark:hover:bg-brand-700 transition text-center">
        ...
        <main className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="pt-24 pb-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/" className="bg-gray-900 dark:bg-brand-600 text-white px-8 py-4 rounded-xl text-base font-semibold hover:bg-gray-800 dark:hover:bg-brand-700 transition shadow-lg shadow-gray-900/20 dark:shadow-brand-500/30 btn-ripple btn-glow">

      ...
      {!stats && (
        <div className="glass-card p-12 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-lg mx-auto">
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 text-center"><div className="text-sm font-medium text-gray-900 dark:text-white flex items-center justify-center gap-1.5"><RefreshCw size={18} strokeWidth={1.75} className="flex-shrink-0" />{t('autoRetry')}</div><div className="text-xs text-gray-500 dark:text-slate-400 mt-1">{t('exponentialBackoff')}</div></div>
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 text-center"><div className="text-sm font-medium text-gray-900 dark:text-white flex items-center justify-center gap-1.5"><BarChart3 size={18} strokeWidth={1.75} className="flex-shrink-0" />{t('perEndpoint')}</div><div className="text-xs text-gray-500 dark:text-slate-400 mt-1">{t('customLimits')}</div></div>
            <div className="bg-gray-50 dark:bg-slate-800 rounded-xl p-4 text-center"><div className="text-sm font-medium text-gray-900 dark:text-white flex items-center justify-center gap-1.5"><Bell size={18} strokeWidth={1.75} className="flex-shrink-0" />{t('alerts')}</div><div className="text-xs text-gray-500 dark:text-slate-400 mt-1">{t('throttleNotifications')}</div></div>
          </div>
        </div>
      )}

export default function Loading() {
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="glass-card p-6">
        <div className="h-4 bg-gray-200 dark:bg-slate-700 rounded-sm w-full mb-3" />
        <div className="h-4 bg-gray-200 dark:bg-slate-700 rounded-sm w-5/6 mb-3" />
        <div className="h-4 bg-gray-200 dark:bg-slate-700 rounded-sm w-4/6" />
      </div>
    </div>
  );
}

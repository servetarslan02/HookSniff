  ...
  const sections = [
    {
      ...
      items: [
        ...
        { name: '🔗 Core', href: '/core', icon: '' },
        { name: '📡 Monitoring', href: '/monitoring', icon: '' },
        { name: '🛠️ DevTools', href: '/devtools', icon: '' },
        { name: '📐 Content', href: '/content-mgmt', icon: '' },
        { name: '🖼️ Portal', href: '/portal-section', icon: '' },
        { name: '🔒 Security', href: '/security-section', icon: '' },
        { name: '🔀 Routing', href: '/routing-config', icon: '' },
        { name: '👥 Team', href: '/team-mgmt', icon: '' },
        { name: '💳 Billing', href: '/billing-overview', icon: '' },
        { name: '⚙️ Settings', href: '/settings-section', icon: '' },
      ],
    },
  ];

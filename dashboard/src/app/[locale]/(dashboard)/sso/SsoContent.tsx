...
import { AlertTriangle, BarChart3, Building2, Check, CheckCircle2, ClipboardList, Eye, EyeOff, ExternalLink, Globe, Info, Key, Pencil, Shield, ShieldCheck, Users, XCircle } from '@/components/icons';
        ...
        <div className="flex gap-3 items-start">
          <div className="flex-1">
            <select value={h.selectedTemplate} onChange={(e) => h.handleTemplateSelect(e.target.value)} disabled={h.isEnforced}
              ...
              <option value="">{h.t('manualSetup') || ' Manual Setup'}</option>

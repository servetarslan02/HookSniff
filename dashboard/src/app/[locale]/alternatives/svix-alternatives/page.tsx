      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  ...
                  { name: 'HookSniff', price: '$49/mo', sdks: '11', oss: '✅', self: '✅', soc2: 'Ready', sla: '99.9%', highlight: true },
                  ...
                  <tr key={row.name} className={`border-b border-gray-100 dark:border-slate-800/50 last:border-0 ${row.highlight ? 'bg-brand-50/30 dark:bg-brand-500/5' : ''}`}>
        ...
        <div className="space-y-8 mb-16">
          {alternatives.map((alt) => (
            <div key={alt.name} className={`rounded-xl border overflow-hidden ${alt.name === 'HookSniff' ? 'border-brand-300 dark:border-brand-500/40 ring-1 ring-brand-300 dark:ring-brand-500/40' : 'border-gray-200 dark:border-slate-800'}`}>
              <div className={`p-6 ${alt.name === 'HookSniff' ? 'bg-brand-50 dark:bg-brand-500/10' : 'bg-white dark:bg-slate-900'}`}>

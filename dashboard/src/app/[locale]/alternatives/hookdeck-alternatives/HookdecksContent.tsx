...
export function HookdecksContent() {
  ...
  return (
    <div>
      <PublicNavbar pageTitle={t('hookdeckAlternativesTitle')} />
        ...
        <div className="space-y-6 mb-16">
          <div className="p-6 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl border border-emerald-200 dark:border-emerald-500/20">
            ...
            <ul className="space-y-2 text-sm text-gray-600 dark:text-slate-400">
              ...
              <li className="flex items-start gap-2"><svg className="w-4 h-4 text-emerald-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>{t('hookdeckSelfHostedDesc')}</li>
              ...
              <li className="flex items-start gap-2"><svg className="w-4 h-4 text-emerald-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>{t('hookdeckMoreSdksDesc')}</li>
            </ul>
          </div>

      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden mb-12">
          <div className="overflow-x-auto"><table className="w-full text-sm">
            ...
            <tbody>{[
              { featureKey: 'sdkCount', hooksniff: '11', hook0: '4' },
              { featureKey: 'fifoDelivery', hooksniff: '✅', hook0: '❌' },
              { featureKey: 'cloudEvents', hooksniff: '✅', hook0: '❌' },
              { featureKey: 'schemaRegistry', hooksniff: '✅', hook0: '❌' },
              { featureKey: 'selfHosted', hooksniff: '✅', hook0: '✅' },
              { featureKey: 'openSource', hooksniff: '✅', hook0: '✅' },
              { featureKey: 'i18n', hooksniff: '✅', hook0: '❌' },
            ].map((r) => (
        ...
        <div className="p-6 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl border border-emerald-200 dark:border-emerald-500/20 mb-8">
          ...
          <p className="text-sm text-gray-600 dark:text-slate-400">{t('migratingFrom', { alternative: 'Hook0' })}</p>
        </div>

...
const rows = [
  ...
  { feature: 'Free tier', hooksniff: '1,000 events', svix: 'Unlimited*', winner: 'svix' },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="p-6 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl border border-emerald-200 dark:border-emerald-500/20 mb-8">
          ...
          <p className="text-sm text-gray-600 dark:text-slate-400">HookSniff Pro is <strong>$29/mo</strong> vs Svix Professional at <strong>$490/mo</strong>. That&apos;s <strong>$5,532/year saved</strong> — with more features. If you don&apos;t need SOC 2 Type 2 or 99.99% SLA, HookSniff is the clear winner for startups and growing teams.</p>
        </div>

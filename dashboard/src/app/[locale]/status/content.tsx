...
function unreachableData(): StatusData {
  return {
    ...
    uptime_30d: 0,
    components: [
      { name: 'API', icon: 'zap', status: 'unknown', latency_ms: null, description: 'HookSniff REST API (Cloud Run)', last_checked: new Date().toISOString() },
      { name: 'Dashboard', icon: 'monitor', status: 'unknown', latency_ms: null, description: 'Next.js frontend (Vercel)', last_checked: new Date().toISOString() },
      { name: 'Worker', icon: 'settings', status: 'unknown', latency_ms: null, description: 'Background delivery worker (Cloud Run)', last_checked: new Date().toISOString() },
      { name: 'Database', icon: 'database', status: 'unknown', latency_ms: null, description: 'PostgreSQL (Neon)', last_checked: new Date().toISOString() },
      { name: 'Cache', icon: 'harddrive', status: 'unknown', latency_ms: null, description: 'Redis (Upstash)', last_checked: new Date().toISOString() },
    ],

...
export default function AdminRevenuePage() {
  ...
  const [planForm, setPlanForm] = useState({
    plan_price_startup: settings?.plan_price_startup ?? 29,
    plan_price_pro: settings?.plan_price_pro ?? 49,
    plan_price_enterprise: settings?.plan_price_enterprise ?? 149,
    max_endpoints_free: settings?.max_endpoints_free ?? 2147483647,
    max_endpoints_startup: settings?.max_endpoints_startup ?? 2147483647,
    max_endpoints_pro: settings?.max_endpoints_pro ?? 2147483647,
    max_endpoints_enterprise: settings?.max_endpoints_enterprise ?? 2147483647,
    max_webhooks_free: settings?.max_webhooks_free ?? 300,
    max_webhooks_startup: settings?.max_webhooks_startup ?? 30000,
    max_webhooks_pro: settings?.max_webhooks_pro ?? 100000,
    max_webhooks_enterprise: settings?.max_webhooks_enterprise ?? 2147483647,
    ...
    retention_days_free: settings?.retention_days_free ?? 14,
    retention_days_startup: settings?.retention_days_startup ?? 30,

  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-card p-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4"><Mail size={16} strokeWidth={1.75} className="inline mr-1" /> {t('emailSettings') || 'Email Settings'}</h2>
      ...
      {/* Security Settings */}
      <div className="glass-card p-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4"><ShieldCheck size={16} strokeWidth={1.75} className="inline mr-1" /> {t('securitySettings') || 'Security & Webhook Settings'}</h2>
        <div className="space-y-4">
          <div>
      ...
      {/* Backup Settings */}
      <div className="glass-card p-6">
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-4"><HardDrive size={16} strokeWidth={1.75} className="inline mr-1" /> {t('backupSettings') || 'Backup Settings'}</h2>
        <div>

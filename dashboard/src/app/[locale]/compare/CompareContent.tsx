...
const tlDr = [
  'HookSniff is 10x cheaper than Svix ($49/mo vs $490/mo) with more features.',
...
const sections = [
  ...
  },
  {
    ...
    hooksniff: { text: 'Pro: $49/mo. 10,000 free events/mo. $0.50 per 100K events. 20% annual discount. All features included.', badge: '$49/mo' },
...
const faq = [
  { q: 'Is HookSniff really cheaper than Svix?', a: 'Yes. HookSniff Pro is $49/mo vs Svix Professional at $490/mo. That\'s $5,532/year saved. HookSniff even offers a free tier with 10,000 events/month.' },
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { when: 'Choose HookSniff if...', items: ['You want the best price/feature ratio ($49/mo)', 'You need FIFO ordered delivery', 'You want CloudEvents standard support', 'You\'re a startup watching costs', 'You want self-hosted + managed options', 'You need a schema registry'] },

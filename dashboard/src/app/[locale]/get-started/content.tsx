...
curl -X POST https://your-api.trycloudflare.com/v1/endpoints \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  -d '{"url": "https://myapp.com/webhooks"}'

# 2. Send a webhook
curl -X POST https://your-api.trycloudflare.com/v1/webhooks \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\

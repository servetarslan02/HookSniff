...
function RoiCalculator() {
  ...
  const hooksniffCost = events <= 0 ? 0 : events <= 3000 ? 0 : events <= 30000 ? 29 : events <= 100000 ? 49 : 149;
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-8 sm:mb-12 md:mb-16">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">
            {t('heroTitle')}
          </h1>

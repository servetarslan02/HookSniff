...
const sections = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Payload Transforms', desc: 'Filter, rename, and enrich webhook payloads before delivery.', href: '/docs/transforms' },
      { title: 'Templates', desc: 'Pre-built webhook configurations for common scenarios.', href: '/docs/templates' },
      { title: 'Integrations', desc: 'Connect with Stripe, GitHub, Shopify, and more.', href: '/docs/integrations' },
  ...
  },
  {
    ...
    cards: [
      ...
      { title: 'Debug Failed Webhooks', desc: 'Investigate and fix delivery failures step by step.', href: '/docs/debug-failed-webhooks' },
    ],
  },
  {
    titleKey: 'reference',
    cards: [
      { title: 'API Reference', desc: 'Complete REST API documentation with examples.', href: '/docs/api-reference' },
      ...
      { title: 'Changelog', desc: 'Release history and version notes.', href: '/docs/changelog' },
    ],
  },
  {
    titleKey: 'operations',
    cards: [
      ...
      { title: 'Monitor Performance', desc: 'Track metrics, set up alerts, and monitor webhook health.', href: '/docs/monitor-performance' },
      ...
      { title: 'Support', desc: 'Get help — GitHub Issues, email, and security reports.', href: '/docs/support' },
    ],
  },
  {
    titleKey: 'understanding',
    cards: [
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="mt-1 text-[13px] text-gray-500 dark:text-slate-500 leading-relaxed">
                  {link.titleKey === 'quickStart' ? t('gettingStartedDesc') : link.titleKey === 'sdks' ? t('sdksDesc') : t('apiReferenceDesc')}
                </p>
              </div>
            </Link>
          ))}
      ...
      <section className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 rounded-xl border border-gray-200/60 dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.02] p-5">
          ...
          <code className="text-sm font-mono text-gray-800 dark:text-slate-300 break-all">
            https://your-api.trycloudflare.com/v1
          </code>
        </div>
        <div className="flex-1 rounded-xl border border-gray-200/60 dark:border-white/[0.06] bg-gray-50 dark:bg-white/[0.02] p-5">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-2 h-2 rounded-full bg-[#4c6ef5]" />
            <span className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-slate-500">{tp('auth')}</span>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-gray-50 dark:bg-white/[0.02]">
                  <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-slate-500">{tp('plan')}</th>
                  <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-slate-500">{tp('requestsPerMin')}</th>
                  <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-slate-500">{tp('eventsPerDay')}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 dark:divide-white/[0.04]">
                {[
                  { plan: 'Developer', price: '$0', rpm: '100', events: '300', highlight: false },
                  { plan: 'Startup', price: '$29/mo', rpm: '500', events: '30,000', highlight: false },

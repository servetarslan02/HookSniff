        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
              <tr><td className="px-4 py-3 font-medium">Developer</td><td className="px-4 py-3">$0</td><td className="px-4 py-3">300</td><td className="px-4 py-3">Unlimited</td><td className="px-4 py-3">256 KB</td><td className="px-4 py-3">7 days</td></tr>

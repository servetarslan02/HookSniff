...
async function BillingPlansPageContent(params: Promise<{ locale: string }>) {
        ...
        <div className="overflow-x-auto mb-6">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-slate-700">
              <tr><td className="px-4 py-3 font-medium">Developer</td><td className="px-4 py-3">$0</td><td className="px-4 py-3">300</td><td className="px-4 py-3">5</td><td className="px-4 py-3">256 KB</td><td className="px-4 py-3">7 days</td></tr>
              <tr><td className="px-4 py-3 font-medium">Startup</td><td className="px-4 py-3">$29/mo</td><td className="px-4 py-3">30,000</td><td className="px-4 py-3">20</td><td className="px-4 py-3">1 MB</td><td className="px-4 py-3">14 days</td></tr>
              <tr><td className="px-4 py-3 font-medium">Pro</td><td className="px-4 py-3">$49/mo</td><td className="px-4 py-3">100,000</td><td className="px-4 py-3">50</td><td className="px-4 py-3">5 MB</td><td className="px-4 py-3">180 days</td></tr>
              <tr><td className="px-4 py-3 font-medium">Enterprise</td><td className="px-4 py-3">$149/mo</td><td className="px-4 py-3">Unlimited</td><td className="px-4 py-3">200</td><td className="px-4 py-3">10 MB</td><td className="px-4 py-3">365 days</td></tr>
            </tbody>
          </table>
        </div>
      </section>
...
export default async function Page(params: Promise<{ locale: string }>) {
  return (
    <Suspense fallback={<div className="animate-pulse space-y-4"><div className="h-8 w-64 rounded bg-gray-200 dark:bg-gray-700" /><div className="h-4 w-full rounded bg-gray-200 dark:bg-gray-700" /><div className="h-4 w-3/4 rounded bg-gray-200 dark:bg-gray-700" /><div className="h-64 w-full rounded bg-gray-200 dark:bg-gray-700" /></div>}>
      <BillingPlansPageContent {...params} />
    </Suspense>
  );
}

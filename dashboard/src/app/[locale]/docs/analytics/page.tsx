...
async function AnalyticsPageContent(params: Promise<{ locale: string }>) {
...
curl -H "Authorization: Bearer YOUR_API_KEY" \\
  "https://your-api.trycloudflare.com/v1/analytics/deliveries?range=7d"

# Success rate
curl -H "Authorization: Bearer YOUR_API_KEY" \\
  "https://your-api.trycloudflare.com/v1/analytics/success-rate?range=30d"

# Latency trend
curl -H "Authorization: Bearer YOUR_API_KEY" \\
  "https://your-api.trycloudflare.com/v1/analytics/latency?range=7d"`} />
      </section>
    </article>
  );
}

      ...
      <section className="space-y-6">
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <ol className="space-y-3 text-sm text-gray-700 dark:text-slate-300 list-decimal list-inside">
            ...
            <li>Redirect URI: <code className="bg-gray-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-xs">https://podcasts-settled-frames-soft.trycloudflare.com/v1/sso/oidc/callback</code></li>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <ol className="space-y-3 text-sm text-gray-700 dark:text-slate-300 list-decimal list-inside">
            ...
            <li>Authorized redirect URI: <code className="bg-gray-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-xs">https://podcasts-settled-frames-soft.trycloudflare.com/v1/sso/oidc/callback</code></li>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <ol className="space-y-3 text-sm text-gray-700 dark:text-slate-300 list-decimal list-inside">
            ...
            <li>Application type: <strong>Web Application</strong></li>
            <li>Sign-in redirect URI: <code className="bg-gray-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-xs">https://podcasts-settled-frames-soft.trycloudflare.com/v1/sso/oidc/callback</code></li>
            <li>Copy <strong>Client ID</strong> and <strong>Client Secret</strong></li>
            <li>In HookSniff SSO page:
              <ul className="ml-6 mt-1 space-y-1">
                <li>• Provider: <strong>OIDC</strong></li>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <ol className="space-y-3 text-sm text-gray-700 dark:text-slate-300 list-decimal list-inside">
            ...
            <li>Valid redirect URIs: <code className="bg-gray-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-xs">https://podcasts-settled-frames-soft.trycloudflare.com/v1/sso/oidc/callback</code></li>
        ...
        <div className="glass-card p-6 space-y-4">
          ...
          <ol className="space-y-3 text-sm text-gray-700 dark:text-slate-300 list-decimal list-inside">
            ...
            <li>Set <strong>ACS URL</strong>: <code className="bg-gray-100 dark:bg-slate-800 px-1.5 py-0.5 rounded text-xs">https://podcasts-settled-frames-soft.trycloudflare.com/v1/sso/saml/callback</code></li>

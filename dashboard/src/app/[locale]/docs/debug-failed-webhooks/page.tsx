...
async function DebugFailedWebhooksPageContent(params: Promise<{ locale: string }>) {
  ...
  return (
    <article className="prose prose-gray max-w-none">
      ...
      <section className="mb-12">
        ...
        <CodeBlock
          code={`curl "https://your-api.trycloudflare.com/v1/webhooks?status=failed&per_page=10" \\
  -H "Authorization: Bearer hr_live_YOUR_KEY"`}
      ...
      <section className="mb-12">
        ...
        <CodeBlock
          code={`curl "https://your-api.trycloudflare.com/v1/webhooks/wh_xyz789/attempts" \\
  -H "Authorization: Bearer hr_live_YOUR_KEY"`}
        />

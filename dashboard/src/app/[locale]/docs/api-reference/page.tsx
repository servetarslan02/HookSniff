...
async function ApiReferenceContent(params: Promise<{ locale: string }>) {
  ...
  return (
    <article className="prose prose-gray max-w-none">
      ...
      <p className="text-lg text-gray-600 dark:text-slate-400 mb-8">
        Complete reference for the HookSniff REST API. Base URL: <code className="bg-gray-100 dark:bg-slate-800 px-1.5 py-0.5 rounded-sm text-sm">https://your-api.trycloudflare.com/v1</code>
      </p>
...
export default async function ApiReferencePage(params: Promise<{ locale: string }>) {
  return (

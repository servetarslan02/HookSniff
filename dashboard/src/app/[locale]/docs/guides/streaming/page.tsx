  ...
  return (
    <article className="prose prose-gray max-w-none">
      ...
      <section className="mb-12">
        ...
        <CodeBlock
          code={`curl -N https://atlas-wales-commons-oriental.trycloudflare.com/v1/stream/deliveries \\
...
// stream.close();`}
      ...
      <section className="mb-12">
        ...
        <CodeBlock
          code={`curl -X POST https://atlas-wales-commons-oriental.trycloudflare.com/v1/endpoints/EP_ID/rate-limit \\
  -H "Authorization: Bearer hr_live_YOUR_KEY" \\

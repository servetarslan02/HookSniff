...
export default function ChangelogPage() {
  return (
    <article className="prose prose-gray max-w-none">
      <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-2">Changelog</h1>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">v1.0.0 — SDK Release</h2>
        <p className="text-sm text-gray-500 dark:text-slate-500 mb-4">2026-05-17</p>

        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Added — SDKs (11 languages)</h3>
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Added — Platform</h3>
        <ul className="space-y-1 text-gray-600 dark:text-slate-400 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Added — CI/CD</h3>
        <ul className="space-y-1 text-gray-600 dark:text-slate-400 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">Fixed</h3>
      ...
      {/* Earlier */}
      <section>
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Earlier Releases</h2>
        <p className="text-gray-600 dark:text-slate-400">
          See the full changelog on <a href="https://github.com/servetarslan02/HookSniff/blob/main/CHANGELOG.md" className="text-brand-600 hover:text-brand-700" target="_blank" rel="noopener noreferrer">GitHub</a>.
        </p>
      </section>
    </article>
  );

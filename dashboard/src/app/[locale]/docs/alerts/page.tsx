...
curl -H "Authorization: Bearer YOUR_API_KEY" \\
  https://podcasts-settled-frames-soft.trycloudflare.com/v1/alerts

# Create alert rule
curl -X POST https://podcasts-settled-frames-soft.trycloudflare.com/v1/alerts \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\
  -d '{"name": "High failures", "condition": "failure_rate", "threshold": 5, "channels": ["email"]}'

# Test alert
curl -X POST https://podcasts-settled-frames-soft.trycloudflare.com/v1/alerts/ALERT_ID/test \\
  -H "Authorization: Bearer YOUR_API_KEY"`} />
      </section>
      <section className="mb-12">

  ...
  const sidebarNav: NavGroup[] = [
    {
      ...
      items: [
        ...
        { name: 'SDKs (11 Languages)', href: '/docs/sdk-libraries' },
      ],
    },
    {
      title: 'How-To Guides',
      items: [
        ...
        { name: '🛡️ Error Handling', href: '/docs/guides/error-handling' },
        ...
        { name: '🏗️ Build Stripe-like', href: '/docs/build-stripe-like' },
      ],
    },
    {
      title: 'Reference',
      items: [
        ...
        { name: '⚙️ Configuration', href: '/docs/configuration' },
        { name: '📋 Event Types', href: '/docs/event-types' },
        { name: '🔑 Idempotency', href: '/docs/idempotency' },
        { name: '☁️ CloudEvents', href: '/docs/cloudevents' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: '🏗️ Architecture', href: '/docs/architecture' },
      ],
    },
    {
      title: 'Operations',
      items: [
        { name: '🖥️ Dashboard', href: '/docs/dashboard' },

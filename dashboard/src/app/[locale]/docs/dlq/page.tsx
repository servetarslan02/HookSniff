...
async function DlqPageContent(params: Promise<{ locale: string }>) {
  ...
  return (
    <article className="prose prose-gray max-w-none">
      ...
      <section className="mb-12">
        ...
        <CodeBlock
          code={`curl "https://atlas-wales-commons-oriental.trycloudflare.com/v1/webhooks?status=failed" \\

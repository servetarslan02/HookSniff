...
curl -H "Authorization: Bearer YOUR_API_KEY" \\
  https://your-api.trycloudflare.com/v1/environments

# Create environment
curl -X POST https://your-api.trycloudflare.com/v1/environments \\
...
# List variables
curl -H "Authorization: Bearer YOUR_API_KEY" \\
  https://your-api.trycloudflare.com/v1/environments/ENV_ID/variables

# Create variable
curl -X POST https://your-api.trycloudflare.com/v1/environments/ENV_ID/variables \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json" \\

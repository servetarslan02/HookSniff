...
const dimensions = [
  ...
  },
  {
    ...
    hooksniff: '$49/mo (Pro plan) — no engineers needed for maintenance',
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="p-6 bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-800 text-center">
            <p className="text-3xl font-bold text-brand-600 dark:text-brand-400 mb-2">$49/mo</p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  { item: 'Monthly cost (Pro)', cost: '$49/mo' },

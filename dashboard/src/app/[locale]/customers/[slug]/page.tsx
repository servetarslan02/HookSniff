...
const stories: Record<string, {
  ...
  'fintech-startup': {
    ...
    logo: 'PS',
    industry: 'Fintech',
    tagline: 'How PayStack achieved zero event loss for financial compliance with HookSniff\'s FIFO delivery',
    website: 'paystack.io',
    size: '28 employees',
    events: '15,000/day',
    ...
    quoteRole: 'Head of Engineering, PayStack',
    problem: [
    ...
    results: [
      ...
      { label: 'Fraud alert latency', before: '45 seconds', after: '<200ms' },
      { label: 'Audit compliance', before: 'Manual', after: 'Automated' },
      { label: 'Reconciliation errors', before: '12/month', after: '0/month' },
    ],
  ...
  'saas-integration': {
    ...
    results: [
      ...
      { label: 'Integration time', before: '2-3 weeks', after: '2 hours' },
      { label: 'Customer satisfaction', before: 'No webhooks', after: 'Real-time' },
      { label: 'Engineering effort', before: 'Full-time', after: 'Zero' },
    ],
  ...
  'healthcare-saas': {
    ...
    results: [
      { label: 'No-show rate', before: '15%', after: '3%' },
      { label: 'Data region', before: 'US', after: 'EU (Frankfurt)' },
      { label: 'Compliance status', before: 'At risk', after: 'GDPR compliant' },
      { label: 'Missed notifications', before: '200/month', after: '0/month' },
    ],
  ...
  'devtools-platform': {
    ...
    results: [
      ...
      { label: 'Integration requests', before: '50/month', after: '5/month (self-serve)' },
      { label: 'Time to first webhook', before: '3 days', after: '15 minutes' },
      { label: 'Support tickets', before: '40/month', after: '8/month' },
    ],
